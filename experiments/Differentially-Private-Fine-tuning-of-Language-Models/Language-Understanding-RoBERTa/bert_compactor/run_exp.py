...
parser.add_argument('--n', default=4, type=int, help='number of korn products')
parser.add_argument('--k', default=96, type=int, help='number of bottleneck dimension')
parser.add_argument('--accountant', default='prv', type=str, choices=['moments', 'prv'], help='privacy accounting method')
parser.add_argument('--rank', default=1, type=int, help='repara rank')
...
apdx += ' --rank %d --sigma %f --clip %f --n %d --k %d '%(args.rank, sigma, args.clip, args.n, args.k)
metric='accuracy'
n_classes=2
if(args.task == 'MNLI'):
    n_classes = 3
